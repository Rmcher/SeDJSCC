...
if __name__ == "__main__":
    ...
    parser.add_argument("-md", '--model_dir', help="dir for model", default='/home/wbh/JSCC/bdjscc_reconstruct/model/')
    ...
    parser.add_argument("-e", "--epochs", help="epochs for training", default=500, type=int)
    ...
    parser.add_argument("-tcn", "--transmit_channel_num", help="transmit_channel_num for djscc model", default=16,
                        type=int)
    parser.add_argument("-snr_train", "--snr_train", help="snr for training", default=20, type=int)
    parser.add_argument("-ldd", "--loss_dir", help="loss_dir for training", default='/home/wbh/JSCC/bdjscc_reconstruct/loss/')
    parser.add_argument("-ed", "--eval_dir", help="eval_dir", default='/home/wbh/JSCC/bdjscc_reconstruct/eval/')
    global args
...
# command
# python /home/wbh/JSCC/bdjscc_reconstruct/bdjscc.py train
# python /home/wbh/JSCC/bdjscc_reconstruct/bdjscc.py eval_mismatch